  ...
  return (
    <>
      ...
      {open && <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            To signup, please fill in your username, email and create a password.
          </DialogContentText>
          { error ? (
            <Alert severity="error">There was an issue signing up, please adjust username, email and password and try again.</Alert>
          ) : null }
          <TextField
            autoFocus
            margin="dense"
